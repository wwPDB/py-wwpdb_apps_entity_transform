...
wwPDB Entity transformer application framework.
...
#  - URL mapping and application specific classes are launched from EntityWebApp()
...
class MyRequestApp(object):
    ...
    def __call__(self, environment, responseApplication):
        ...
        ###
        entmodule = EntityWebApp(parameterDict=self._myParameterDict,verbose=self.__verbose, 
